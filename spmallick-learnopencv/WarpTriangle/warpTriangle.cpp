...
void warpTriangle(Mat &img1, Mat &img2, vector<Point2f> tri1, vector<Point2f> tri2)
{
    ...
    fillConvexPoly(mask, tri2CroppedInt, Scalar(1.0, 1.0, 1.0), LINE_AA);
...
int main(int argc, char **argv)
{
    ...
    polylines(imgIn, triInInt, true, color, 2, LINE_AA);
    polylines(imgOut, triOutInt, true, color, 2, LINE_AA);
