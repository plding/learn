...
void morphTriangle(Mat &img1, Mat &img2, Mat &img, vector<Point2f> &t1, vector<Point2f> &t2,
                   vector<Point2f> &t, double alpha)
{
    ...
    fillConvexPoly(mask, tRectInt, Scalar(1.0, 1.0, 1.0), LINE_AA);
