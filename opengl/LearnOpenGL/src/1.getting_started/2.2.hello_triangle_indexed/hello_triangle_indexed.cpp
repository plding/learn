...
int main()
{
    ...
    // You can unbing the VAO afterwards so other VAO calls won't accidentally modify this
    // VAO, but this rarely happens. Modifying other VAOs requires a call glBindVertexArray
